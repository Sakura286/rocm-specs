...
# Parallelism managed dynamically based on available resources
...
# The upstream hipBLASLt project has a hard fork of the python-tensile package
# that rocBLAS uses. The two versions are incompatible.
...
# Defer install libdir to cmake command line
...
# Replace all mentions of 'amdclang' with 'clang' in the Tensile Python files
