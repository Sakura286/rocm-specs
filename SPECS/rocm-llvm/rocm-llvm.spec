...
Patch1:         1000-comgr-Options-changes-for-comgr.patch
Patch2:         1001-comgr-remove-Driver-from-GetResourcesPath.patch
...
Patch3:         1002-device-libs-add-cube-lerp-qsad-sad-target-features.patch
